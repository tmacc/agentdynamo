...
export const TeamAgentsSettings = Schema.Struct({
  ...
  maxActiveChildren: Schema.Int.pipe(
    Schema.withDecodingDefault(Effect.succeed(DEFAULT_MAX_ACTIVE_TEAM_CHILDREN)),
  ),
  autoNameChildren: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
});
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  teamAgents: Schema.optionalKey(
    Schema.Struct({
      enabled: Schema.optionalKey(Schema.Boolean),
      maxActiveChildren: Schema.optionalKey(Schema.Int),
      autoNameChildren: Schema.optionalKey(Schema.Boolean),
    }),
  ),
