...
export const ClientSettingsSchema = Schema.Struct({
  ...
  worktreeReadinessPromptStateByProjectId: Schema.Record(
    Schema.String,
  ...
  sidebarProjectGroupingOverrides: Schema.Record(Schema.String, SidebarProjectGroupingMode).pipe(
...
export const DEFAULT_CLIENT_SETTINGS: ClientSettings = Schema.decodeUnknownSync(
...
export const ServerSettings = Schema.Struct({
  ...
  teamAgents: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(false))),
...
export const ServerSettingsPatch = Schema.Struct({
  ...
  teamAgents: Schema.optionalKey(Schema.Boolean),
