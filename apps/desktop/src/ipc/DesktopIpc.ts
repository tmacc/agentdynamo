...
export interface DesktopSyncIpcMethodWithPayloadRegistration<
  Payload,
  EncodedPayload,
  Result,
  EncodedResult,
...
export const makeSyncIpcMethodWithPayload = <
  Payload,
  EncodedPayload,
  Result,
  EncodedResult,
  ...
  ResultEncodingServices = never,
>(
  method: DesktopSyncIpcMethodWithPayloadRegistration<
    Payload,
    EncodedPayload,
    Result,
    EncodedResult,
