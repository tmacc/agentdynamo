...
export const GET_SAVED_PROMPT_STORAGE_CHANNEL = "desktop:get-saved-prompt-storage";
export const SET_SAVED_PROMPT_STORAGE_CHANNEL = "desktop:set-saved-prompt-storage";
export const REMOVE_SAVED_PROMPT_STORAGE_CHANNEL = "desktop:remove-saved-prompt-storage";
