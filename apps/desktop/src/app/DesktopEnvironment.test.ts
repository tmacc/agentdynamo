...
describe("DesktopEnvironment", () => {
  it.effect("derives state paths and development identity inside Effect", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.savedPromptsPath, "/tmp/t3/dev/saved-prompts.json");
      ...
      assert.equal(environment.appUserModelId, "com.agentdynamo.dynamo.dev");
      assert.equal(environment.linuxWmClass, "dynamo-dev");
      assert.deepEqual(
