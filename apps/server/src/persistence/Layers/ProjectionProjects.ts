...
import { ModelSelection, ProjectScript, ProjectWorktreeSetupProfile } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.worktreeSetup !== null ? JSON.stringify(row.worktreeSetup) : null},
          ${row.createdAt},
          ${row.updatedAt},
          ${row.deletedAt}
        )
        ...
        DO UPDATE SET
          ...
          worktree_setup_json = excluded.worktree_setup_json,
