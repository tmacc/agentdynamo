...
import {
  GitManagerError,
  GitCommandError,
  type GitApplyWorktreePatchInput,
  type GitApplyWorktreePatchResult,
  type GitGetPullRequestRemoteOptionsInput,
  ...
  type GitPreviewWorktreePatchInput,
  ...
  type GitSetPullRequestRemoteInput,
...
export const make = Effect.fn("makeGitWorkflowService")(function* () {
  ...
  return GitWorkflowService.of({
    ...
    getPullRequestRemoteOptions: routeGitManager(
      "GitWorkflowService.getPullRequestRemoteOptions",
      gitManager.getPullRequestRemoteOptions,
    ),
    setPullRequestRemote: routeGitManager(
      "GitWorkflowService.setPullRequestRemote",
      gitManager.setPullRequestRemote,
    ),
    preparePullRequestThread: routeGitManager(
      "GitWorkflowService.preparePullRequestThread",
      gitManager.preparePullRequestThread,
    ),
    previewWorktreePatch: gitManager.previewWorktreePatch,
    applyWorktreePatch: gitManager.applyWorktreePatch,
    listRefs: (input) =>
