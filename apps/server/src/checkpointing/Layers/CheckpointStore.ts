...
const CHECKPOINT_NUMSTAT_MAX_OUTPUT_BYTES = 4_000_000;
...
const makeCheckpointStore = Effect.gen(function* () {
    ...
    yield* Effect.acquireUseRelease(
      ...
      Effect.fn("captureCheckpoint.withTempDirectory")(function* (tempDir) {
        ...
        const commitEnv: NodeJS.ProcessEnv = {
          ...
          GIT_AUTHOR_NAME: "Dynamo",
          GIT_AUTHOR_EMAIL: "dynamo@users.noreply.github.com",
          GIT_COMMITTER_NAME: "Dynamo",
          GIT_COMMITTER_EMAIL: "dynamo@users.noreply.github.com",
        };
  ...
  const summarizeCheckpointDiff: CheckpointStoreShape["summarizeCheckpointDiff"] = Effect.fn(
