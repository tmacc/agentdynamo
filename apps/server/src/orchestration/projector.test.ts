...
describe("orchestration projector", () => {
  ...
  it("treats missing checkpoint placeholders as completed turns", async () => {
    const createdAt = "2026-02-23T08:00:00.000Z";
    ...
    const thread = afterPlaceholder.threads[0];
  ...
  it("preserves assistant message render mode across completion updates", async () => {
    const createdAt = "2026-02-23T09:10:00.000Z";
    const deltaAt = "2026-02-23T09:10:01.000Z";
  ...
  it("leaves message render mode absent when events omit it", async () => {
    const createdAt = "2026-02-23T09:20:00.000Z";
    const messageAt = "2026-02-23T09:20:01.000Z";
    const model = createEmptyReadModel(createdAt);
    ...
    expect(afterMessage.threads[0]?.messages[0]?.renderMode).toBeUndefined();
  });
