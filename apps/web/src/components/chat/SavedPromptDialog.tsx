        ...
        <DialogPanel className="space-y-4">
          ...
          {mode === "create" && bodyPreview ? (
            <div className="grid gap-1.5">
              <span className="font-medium text-foreground text-xs">Prompt text</span>
              <div className="max-h-40 overflow-y-auto rounded-xl border border-border/70 bg-muted/25 px-3 py-2 text-foreground/90 text-sm whitespace-pre-wrap">
                {bodyPreview}
              </div>
            </div>
          ) : null}
          ...
          {mode === "create" ? (
            <div className="grid gap-1.5">
              <span className="font-medium text-foreground text-xs">Scope</span>
              <RadioGroup
                value={scope}
                onValueChange={(value) => {
                  if (!value) return;
              ...
              >
                {projectScopeAvailable ? (
                  ...
                  >
                    ...
                    <span className="grid gap-0.5">
                      <span className="font-medium text-foreground text-sm">This project</span>
                ...
                >
                  ...
                  <span className="grid gap-0.5">
                    <span className="font-medium text-foreground text-sm">All projects</span>
                    <span className="text-muted-foreground text-xs">
