...
const createDesktopBridgeStub = (overrides?: {
  ...
  return {
    ...
    getSavedPromptStorage: vi.fn().mockReturnValue({ status: "missing" }),
    setSavedPromptStorage: vi.fn().mockReturnValue({ status: "ok" }),
    removeSavedPromptStorage: vi.fn().mockReturnValue({ status: "ok" }),
