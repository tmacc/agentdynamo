import { CommandId, FeatureCardId, MessageId, ProjectId, ThreadId } from "@t3tools/contracts";
...
export const newFeatureCardId = (): FeatureCardId => FeatureCardId.make(randomUUID());
